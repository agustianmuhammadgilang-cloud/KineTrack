...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <a href="<?= base_url('admin/bidang/detail/'.$b['id']) ?>" class="block w-full">
        <div class="bg-white dark:bg-gray-800 border-l-4 border-orange-500 shadow-md rounded-lg p-5 hover:shadow-xl hover:-translate-y-1 transition-transform duration-200 cursor-pointer">
