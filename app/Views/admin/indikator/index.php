                        ...
                        <tr class="row-hover">
                            ...
                            <td class="text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button type="button" 
                                            onclick="confirmDelete('<?= base_url('admin/indikator/delete/'.$i['id']) ?>', '<?= esc($i['nama_indikator'], 'js') ?>')"
                                            class="btn-action btn-delete cursor-pointer">
...
<script>
    function confirmDelete(url, namaIndikator) {
        Swal.fire({
            ...
            html: `
                <div class="text-slate-500 text-sm font-medium leading-relaxed">
                    Apakah Anda yakin ingin menghapus indikator <br>
                    <span class="text-blue-600 font-bold">"${namaIndikator}"</span>?
