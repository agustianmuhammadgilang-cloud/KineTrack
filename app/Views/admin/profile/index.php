    ...
    <form action="<?= base_url('admin/profile/update') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama" value="<?= esc($admin['nama'] ?? '') ?>"
                   class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-[var(--polban-blue)]/50"
                   required>
        </div>
        ...
        <!-- BUTTON -->
        <button class="px-5 py-2 bg-[var(--polban-blue)] text-white rounded-lg shadow hover:bg-blue-900 transition">
            Simpan Perubahan
        </button>
