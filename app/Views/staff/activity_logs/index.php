    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
            ...
            <p class="text-slate-500 mt-1 text-sm">
                Riwayat seluruh aktivitas Anda dalam sistem <span class="font-semibold text-slate-700">KINETRACK</span>.
            </p>
            
            <div class="mt-3 inline-flex items-center px-3 py-1 rounded-full bg-amber-50 border border-amber-200 shadow-sm">
        ...
        <div class="p-6 bg-slate-50/30">
            <?php if (empty($logs)): ?>
                <div class="py-20 flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-slate-500 text-sm mt-1 max-w-xs">Sistem belum mencatat aktivitas apa pun untuk akun Anda saat ini.</p>
                </div>
            <?php else: ?>
                <div class="space-y-4">
