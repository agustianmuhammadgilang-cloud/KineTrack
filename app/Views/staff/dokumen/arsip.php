    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 mt-2 font-black uppercase tracking-[0.2em]">Laporan Kinerja Terverifikasi</p>
            </div>
        </div>
...
<form method="get" class="mb-6">
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-slate-50/80 border-b border-slate-100">
                        <th class="px-8 py-5 text-left text-[11px] font-black text-slate-400 uppercase tracking-widest">Detail Dokumen</th>
                        <th class="px-8 py-5 text-center text-[11px] font-black text-slate-400 uppercase tracking-widest">Tanggal Selesai</th>
                        <th class="px-8 py-5 text-center text-[11px] font-black text-slate-400 uppercase tracking-widest">Status</th>
                        <th class="px-8 py-5 text-right text-[11px] font-black text-slate-400 uppercase tracking-widest">Aksi</th>
                    </tr>
                </thead>
                        ...
                        <tr class="group hover:bg-blue-50/30 transition-colors">
                            ...
                            <td class="px-8 py-6 text-right">
                                <a href="<?= base_url('uploads/dokumen/'.$d['file_path']) ?>" target="_blank" 
                                   class="inline-flex items-center gap-2 bg-white border border-slate-200 text-slate-600 hover:text-blue-600 hover:border-blue-200 hover:shadow-md px-4 py-2 rounded-xl text-[11px] font-black transition-all">
    ...
    <div class="mt-8 p-6 bg-white rounded-3xl border border-slate-200 flex flex-col md:flex-row items-center gap-4 shadow-sm">
        ...
        <p class="text-[11px] text-slate-500 font-medium leading-relaxed">
            Data arsip ini bersifat <span class="text-slate-900 font-black italic">Read-Only</span>. Semua dokumen di sini telah melalui proses verifikasi berjenjang oleh Atasan. 
            Gunakan tombol <span class="text-blue-600 font-black">Export</span> di bagian atas untuk kebutuhan pelaporan fisik atau administrasi tambahan.
        </p>
    </div>
