    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-10">
        <div class="flex items-center gap-5">
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-2 font-black uppercase tracking-[0.2em]">Akses Terbuka • Politeknik Negeri Bandung</p>
            </div>
        </div>
    </div>
    ...
    <?php if (empty($dokumen)): ?>
        <div class="py-20 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[2.5rem] text-center">
            <div class="flex flex-col items-center text-slate-300">
                ...
                <h4 class="text-lg font-bold uppercase tracking-widest">Tidak Ada Dokumen Publik</h4>
                <p class="text-sm italic mt-1">Belum ada dokumen yang dipublikasikan secara umum</p>
            </div>
        </div>
    <?php else: ?>
            ...
            <?php foreach ($dokumen as $d): ?>
                <div class="archive-card p-7 group">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <span class="px-3 py-1.5 rounded-xl border bg-emerald-50 text-emerald-600 border-emerald-100 text-[9px] font-black uppercase tracking-widest">
                            Publik
                        </span>
                    </div>
                    ...
                    <div class="mt-4 pt-6 border-t border-slate-50 flex items-center justify-between">
                        <div class="flex flex-col">
                            <span class="text-[9px] font-black text-slate-300 uppercase tracking-widest mb-1 leading-none text-left">Dipublikasikan</span>
