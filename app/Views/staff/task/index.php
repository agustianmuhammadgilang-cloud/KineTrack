...
<div class="min-h-screen bg-light px-6 py-8">
    ...
    <div class="w-full md:w-80 space-y-4">
        ...
        <a href="<?= base_url('staff/rekomendasi') ?>" class="group block relative overflow-hidden bg-white border border-amber-100 rounded-xl p-3 transition-all hover:shadow-md hover:border-amber-300">
