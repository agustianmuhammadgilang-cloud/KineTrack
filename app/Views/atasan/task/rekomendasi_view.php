...
<div class="px-6 py-10 max-w-4xl mx-auto">
    <div class="mb-10">
        <a href="<?= base_url('atasan/task') ?>" class="inline-flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest hover:text-blue-900 transition-colors mb-6">
