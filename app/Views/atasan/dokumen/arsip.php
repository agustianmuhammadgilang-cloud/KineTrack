...
<div class="px-6 py-10 max-w-7xl mx-auto font-sans">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
        <div class="flex items-center gap-5">
            ...
            <div>
                <h1 class="text-3xl font-black text-blue-900 tracking-tight leading-none">Arsip Dokumen Kinerja</h1>
                <p class="text-[11px] text-slate-400 mt-2 font-black uppercase tracking-[0.2em]">Tier Atasan • Laporan Terverifikasi 
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-slate-50/80 border-b border-slate-100">
                        ...
                        <th class="px-8 py-6 text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Unit Asal</th>
                        <th class="px-8 py-6 text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Selesai</th>
                            ...
                            <td class="px-8 py-7">
                                <div class="flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-[10px] text-slate-400 font-bold uppercase tracking-tight mt-1 block">ID: #<?= esc($d['id']) ?></span>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-8 py-24 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-slate-400 font-black text-sm uppercase tracking-widest italic">Arsip Tidak Ditemukan</p>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
    ...
    <div class="mt-8 p-8 bg-blue-900 rounded-[2.5rem] text-white flex flex-col md:flex-row items-center gap-6 shadow-2xl shadow-blue-900/20 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center md:text-left">
            <h5 class="font-black uppercase tracking-widest text-xs mb-1 text-blue-200">Official Tier Access: Atasan</h5>
            <p class="text-xs text-blue-100 font-medium leading-relaxed opacity-80">
                Data arsip ini telah divalidasi dan tersinkronisasi secara otomatis dengan sistem pusat E-Kinerja Polban. Anda mengakses data tingkat unit yang bersifat final.
            </p>
        </div>
    </div>
