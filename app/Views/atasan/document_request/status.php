...
<div class="px-6 py-10 max-w-7xl mx-auto min-h-screen">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h4 class="text-3xl font-black text-blue-900 tracking-tight">Riwayat <span class="text-blue-600">Akses</span></h4>
                <p class="text-[11px] text-slate-400 font-semibold uppercase tracking-[0.2em] mt-1">Kinetrack — Pantau Status Pengajuan Dokumen Anda</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <?php if (empty($requests)): ?>
            <div class="col-span-full py-32 text-center bg-white rounded-[3rem] border-2 border-dashed border-slate-100">
                ...
                <p class="text-slate-400 font-black uppercase tracking-[0.3em] text-[10px]">Belum ada pengajuan akses terdaftar</p>
            </div>
        <?php else: ?>
            <?php foreach ($requests as $req): ?>
            <div class="doc-card p-8 flex flex-col group">
                <div class="flex justify-between items-start mb-6">
                    <div class="w-12 h-12 bg-blue-50 text-blue-900 rounded-2xl flex items-center justify-center border border-blue-100 group-hover:bg-blue-900 group-hover:text-white transition-colors duration-500 shadow-sm">
                ...
                <div class="space-y-4 pt-6 border-t border-slate-100 mt-auto">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest">Pemilik Dokumen</p>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest">Tgl Pengajuan</p>
