...
<div class="max-w-4xl mx-auto py-8 px-4 font-sans text-slate-800">
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-1">
            Kelola informasi kredensial dan tanda tangan digital Anda untuk otoritas atasan.
        </p>
    </div>
    ...
    <div class="bg-white border border-slate-200 shadow-xl rounded-2xl overflow-hidden">
        <form id="formProfile" action="<?= base_url('atasan/profile/update') ?>" method="POST" enctype="multipart/form-data" class="divide-y divide-slate-100">
            ...
            <div class="p-6 md:px-8 py-6 bg-white flex flex-col md:flex-row-reverse gap-3">
                ...
                <a href="<?= base_url('atasan') ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold px-8 py-3 rounded-xl text-center border border-slate-200">Batal</a>
            </div>
        </form>
    </div>
</div>
