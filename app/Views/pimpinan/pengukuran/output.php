...
<div class="px-4 py-8 max-w-7xl mx-auto">
    ...
    <?php if ($selected_tahun && $selected_tw): ?>
    <div class="flex items-center gap-4 bg-white p-2 pl-5 rounded-2xl border border-slate-100 shadow-sm">
        <div class="hidden md:block text-right">
            <p class="text-[10px] font-black text-blue-900 uppercase tracking-widest">Evaluasi TW 0<?= $selected_tw ?></p>
            <p class="text-[9px] text-slate-400 font-medium">Input arahan strategis Anda</p>
        </div>
        <a href="<?= base_url('pimpinan/rekomendasi?tahun_id='.$selected_tahun.'&triwulan='.$selected_tw) ?>" 
           class="flex items-center gap-3 px-5 py-3 bg-[#D4AF37] hover:bg-blue-900 text-white rounded-xl font-bold shadow-lg shadow-amber-600/20 transition-all duration-300 transform hover:-translate-y-1">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
            <span class="text-[11px] uppercase tracking-wider">Berikan Rekomendasi</span>
        </a>
    </div>
    <?php endif; ?>
</div>
    ...
    <div class="glass-card p-8 mb-8">
        <form method="get" action="<?= base_url('pimpinan/pengukuran/output') ?>" class="flex flex-col lg:flex-row items-center gap-8">
...
<div class="glass-card overflow-hidden !border-none shadow-xl shadow-blue-900/5">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="group hover:bg-blue-50/30 transition-colors">
                    ...
                    <td class="p-5 text-center border-none">
                        <a href="<?= base_url('pimpinan/pengukuran/output/detail/'.$ind['id'].'/'.$selected_tahun.'/'.$selected_tw) ?>"
    ...
    <div class="glass-card p-20 text-center">
        ...
        <p class="text-slate-400 text-sm mt-1">Silakan pilih tahun dan triwulan yang berbeda untuk melihat data.</p>
    </div>
    <?php endif; ?>
</div>
